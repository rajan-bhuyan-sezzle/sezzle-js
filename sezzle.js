...
SezzleJS.prototype.renderModal = function() {
  if (!document.getElementsByClassName('sezzle-checkout-modal-lightbox').length) {
    ...
    if (this.altLightboxHTML) {
      ...
      modalNode.innerHTML = '<div class="sezzle-checkout-modal-lightbox" style="display: block;" data-tf-inspect="-1690568171"> <div class="sezzle-checkout-modal"> <div class="top-content"> <div class="sezzle-no-thanks close-sezzle-modal">×</div><div class="sezzle-modal-title-logo"><img src="https://d34uoa9py2cgca.cloudfront.net/Checkout/tobisezzle.png"></div><div class="sezzle-header-text">Buy Now, Pay in 2019</div><hr/> <div class="row point"> <div class="col-xs-2 col-sm-2 col-md-2"><img src="https://d34uoa9py2cgca.cloudfront.net/Checkout/arrow.svg" class="modal-icon"></div><div class="col-xs-8 col-sm-8 modal-description"> <h2>Choose Sezzle at checkout</h2> <p>Approval is fast and easy</p></div></div><div class="row point"> <div class="col-xs-2 col-sm-2 col-md-2"><img src="https://d34uoa9py2cgca.cloudfront.net/Checkout/ship.svg" class="modal-icon"></div><div class="col-xs-8 col-sm-8 modal-description"> <h2>Your order is shipped right away</h2> </div></div><div class="row point"> <div class="col-xs-2 col-sm-2 col-md-2 "><img src="https://d34uoa9py2cgca.cloudfront.net/Checkout/calendar.svg" class="modal-icon"></div><div class="col-xs-8 col-sm-8 modal-description"> <h2>Easy, automatic payments</h2> <p>Pay 25% now and the rest in 2019. Autopay in 3 easy installments with NO INTEREST!</p></div></div></div><div class="sezzle-footer-text">Subject to approval</div><div class="sezzle-footer-link-container"><a href="https://legal.sezzle.com/user" class="sezzle-footer-link">Click here for complete terms</a></div></div></div>';
    }
